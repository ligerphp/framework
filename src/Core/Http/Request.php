...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new Core HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * Create an Core request from a Symfony instance.
     *
     ...
     * Get the session associated with the request.
     *
     * @return \Core\Session\Store|null
     */
     ...
     *
     * @return \Core\Routing\Route|object|string
     */
